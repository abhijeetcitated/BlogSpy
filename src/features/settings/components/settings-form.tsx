...
import { defaultSettings, type UserSettings, type SettingsFormProps } from "../types/settings-form-types"
...
export type { UserSettings, SettingsFormProps } from "../types/settings-form-types"
