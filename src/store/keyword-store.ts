...
// Local type definitions for this legacy store
interface LocalKeywordFilters {
  search: string
  minVolume: number
  maxVolume: number
  minKd: number
...
interface KeywordState {
  ...
  // Filters
  setFilters: (filters: Partial<LocalKeywordFilters>) => void
  resetFilters: () => void
...
const DEFAULT_FILTERS: LocalKeywordFilters = {
  search: "",
  minVolume: 0,
  maxVolume: 1000000,
  minKd: 0,
